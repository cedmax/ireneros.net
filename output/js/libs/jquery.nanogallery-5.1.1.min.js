...
!1,b,a):ua(d)):ta(e,!1,-1,a);return!0}}function N(){p=[];var a="";g.thumbnailLabel.displayDescription&&(a="d");a=V("dummydummydummy","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",a,"","image","","1","0");a=Bb(a,0,0,!1);f.borderWidth=a.outerWidth(!0)-a.width();f.borderHeight=a.outerHeight(!0)-a.height();f.imgcBorderWidth=a.find(".imgContainer").outerWidth(!0)-
...
jb(d,"noID")||(h=!1);if(h&&(d=V(d,"css/nano_gallery.png","data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",s,"",b,"",f,l),d.imageNumber=e,d.contentLength=c.ImageCount,"auto"==m()?(d.thumbImgWidth=v(),d.thumbImgHeight=v()):"auto"==v()?(d.thumbImgWidth=m(),d.thumbImgHeight=m()):(d.thumbImgWidth=m(),d.thumbImgHeight=v()),"function"==typeof g.fnProcessData&&g.fnProcessData(d,"smugmug",c),e++,e>=Na))return!1})}else{d=c.Album.Images;switch(g.photoSorting){case "random":d=
...
"max-height":"350px"}))}g.useTags&&(c=!0,null==Hb&&(Hb=jQuery('<div class="nanoGalleryTags"></div>').appendTo(d.conNavB)));g.galleryFullpageButton&&(c=!0);!Ib&&c&&(Ib=!0,d.conNavBCon.show())}function ib(){d.conLoadingB.css({visibility:"visible"})}function oa(){d.conLoadingB.css({visibility:"hidden"})}function ta(a,c,b,e){switch(g.kind){case "":Y(a,e);break;case "flickr":xb(a,c,b,e);break;case "smugmug":$a(a,c,b,e);break;default:yb(a,c,b,e)}}function Ja(){"auto"==v()?ac():"auto"==m()?bc():cc();lb();
...
jQuery(this).find("img");if("data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw=="==jQuery(a).attr("src")){var b=jQuery(this).data("index");jQuery(a).attr("src","");jQuery(a).attr("src",p[b].thumbImg().src)}})}function dc(a,c){if(void 0!=d.conPagin)if(d.conPagin.children().remove(),"auto"==f.settings.height[G][H]||"auto"==f.settings.width[G][H])d.conPagin.hide();else{d.conPagin.show();d.conPagin.data("galleryIdx",a);d.conPagin.data("currentPageNumber",
...
k+'" style="display:block,opacity:'+b+";"+h+'" ><div class="subcontainer" style="display:block;">';var h="",h=g.thumbnailLazyLoad?"data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==":a.thumbImg().src,k=gc(a),r=hc(a);b=!1;"auto"==v()?(l[f++]='<div class="imgContainer" style="width:'+m()+'px;"><img class="image" src='+h+' alt=" " style="max-width:'+m()+'px;"></div>',0==p[c].thumbImg().height&&(b=!0)):"auto"==m()?(l[f++]='<div class="imgContainer" style="height:'+
...
r+"</div></div>");l[f++]="</div></div>";e=jQuery(l.join("")).appendTo(d.conTnHid);a.$elt=e;e.data("index",c);e.find("img").data("index",c);ic(e,a);if(b)ngimagesLoaded(e).on("always",function(a){var b=p[jQuery(a.images[0].img).data("index")];if(void 0!=b&&"data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw=="!=jQuery(a.images[0].img).attr("src")){var c=!1;b.thumbImg().height!=a.images[0].img.naturalHeight&&(b.thumbSetImgHeight(a.images[0].img.naturalHeight),
...
{src:"",width:0,height:0};if("dummydummydummy"==this.title)return a.src="data:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",a;switch(g.kind){case "smugmug":a.src=this.thumbsrc;a.width=this.thumbImgWidth;a.height=this.thumbImgHeight;break;default:a.src=this.thumbs.url[G][H],a.width=this.thumbs.width[G][H],a.height=this.thumbs.height[G][H]}return a},responsiveURL:function(){var a="";switch(g.kind){case "":a=this.src;break;case "flickr":a=this.src;break;
